  ...
  return (
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="">
          <i class="fa-regular fa-user"></i>Your Zerodha Account </h4>
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="">
          <i class="fa-solid fa-circle-dot"></i> Console </h4>
        ...
        <div className="col-4 p-5 mt-2 mb-52">
          <h4 className="">
          <i class="fa-solid fa-indian-rupee-sign"></i>Coin </h4>
